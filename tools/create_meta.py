...
def main(args):
    ...
    for num_classes in args.sets:
        ...
        set_train = {
            cls: videos
            for cls, videos in train_videos.items() if cls in set_classes
        }
        set_valid = {
            cls: videos
            for cls, videos in validation_videos.items() if cls in set_classes
        }
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        "Create metadata for all downloaded videos with the option to limit the number of "
        "classes included.")
    ...
    parser.add_argument("-s",
                        ...
                        nargs="+",
                        default=[400],
                        help="list of sets to generate, each integer "
